      ...
      <Routes>
       ...
       <Route
        ...
        />
         <Route
          path="/teams/nfl"
          element={<TeamLinks user={state.user} isLoggedin={state.isLoggedin} league="NFL" />}
        />
        <Route
          path="/teams/nba"
          element={<TeamLinks user={state.user} isLoggedin={state.isLoggedin} league="NBA" />}
        />
        <Route
          path="/teams/mlb"
          element={<TeamLinks user={state.user} isLoggedin={state.isLoggedin} league="MLB" />}
        />
         <Route
          path="/teams/nhl"
